...
void main(void)
{
  ...
  while (1) {
	...
	case gecko_evt_gatt_server_user_write_request_id:
			...
			if (evt->data.evt_gatt_server_user_write_request.characteristic==gattdb_dtm_On)
			{
			...
			if (evt->data.evt_gatt_server_user_write_request.characteristic==gattdb_dtm_TestTime)
			{
			...
			if (evt->data.evt_gatt_server_user_write_request.characteristic==gattdb_dtm_Modulation)
			{
			...
			if (evt->data.evt_gatt_server_user_write_request.characteristic==gattdb_dtm_PHY)
			{
			...
			if (evt->data.evt_gatt_server_user_write_request.characteristic==gattdb_dtm_PacketSize)
			{
			...
			if (evt->data.evt_gatt_server_user_write_request.characteristic==gattdb_dtm_Power)
			{
